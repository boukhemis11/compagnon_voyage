...
import com.example.boukh.compagnon_voyage.dummy.DummyContent.DummyItem

/**
 * A fragment representing a list of Items.
 * Activities containing this fragment MUST implement the
 * [StoriesFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyStoryRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
